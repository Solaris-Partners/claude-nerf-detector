...
function findKthLargest(nums, k) {
  ...
  return heap.pop();
        ...
        score: (solution) => scoreAlgorithm(solution)
    },
    {
        id: 'P2',
        name: 'Log Parsing',
...
${JSON.stringify({
        ...
        score: (solution) => scoreLogParsing(solution)
    },
    {
        id: 'P3',
        name: 'Bug Fixing',
...
// 3. No handling for edge cases like negative numbers`;
        ...
        score: (solution) => scoreBugFix(solution)
    },
    {
        id: 'P4',
...
try {
  ...
  process.exit(1);
        ...
        score: (solution) => scoreCLI(solution)
    },
    {
        id: 'P5',
        name: 'Math Reasoning',
...
// Answer: 54.5 mph`;
        ...
        score: (solution) => scoreMath(solution)
    }
];
// Main test execution
