 ...
 */
export function scoreAlgorithm(solution) {
    const metrics = {
        correctness: 0,
        completeness: 0,
        performance: 0,
 ...
 */
export function scoreLogParsing(solution) {
    const metrics = {
        correctness: 0,
        completeness: 0,
        performance: 0,
 ...
 */
export function scoreBugFix(solution) {
    const metrics = {
        correctness: 0,
        completeness: 0,
        performance: 0,
 ...
 */
export function scoreCLI(solution) {
    const metrics = {
        correctness: 0,
        completeness: 0,
        performance: 0,
    ...
    const foundCommands = commands.filter(cmd => new RegExp(`command\\(['"]${cmd}`, 'i').test(solution));
 ...
 */
export function scoreMath(solution) {
    const metrics = {
        correctness: 0,
        completeness: 0,
        performance: 0,
 ...
 */
export function generateReport(testScores) {
...
//# sourceMappingURL=scoring-system.js.map